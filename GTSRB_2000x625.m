...
%% Import Data
Para.datName = 'GTSRB_2000x625';
mat_path = strcat('./00-DemoData/',Para.datName,'.mat');
Data = load(mat_path); [~,n] = size(Data.X);
...
for mod = 1:length(ModS)
    ...
    if sum(ModelName == "L0USVM")
        ...
        Para.rho = 0.0078;                 Para.Update_rho = "OFF";
        Para.eta = 9;                     Para.L0USVM.UpdateRho = "OF";
        Para.itmax = 100;                 Para.L0USVM.UpdateU = "ON";
        Para.WrokSet = "ON";              Para.L0USVM.WorkSetRatio = 0.9;
